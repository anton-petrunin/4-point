...
It follows that all forms $\rho_{\bm{x}}$ for point arrays $\bm{x}$ in $\mathcal{M}_K$-spaces form a convex cone.
...
Since $\tilde\rho$ is minimal, $\bar N$ has to touch $e_i$ in at least 3 directions (up to sign).
...
It means that $\bar N$ lies in a quadrangle or a triangle, respectively, and touches its sides at three points or more.
...
let $(x_1$, $x_2$, $x_3$, $x_4)$ be a 4-point point array in the hyperbolic space.
...
This inequality should be interpreted as a $(3,1)$-inequality with a $\lambda$-array $(\lambda_1,\lambda_2,\lambda_3,-1)$ with error
\[10\cdot\delta^2\cdot \lambda_1\cdot\lambda_2\cdot\lambda_3\cdot (|x_1-x_2|_X^2+|x_2-x_3|_X^2+|x_3-x_1|_X^2).\]
...
Note that for a general 4-point array, $\tilde d_v$ and $\tilde d_w$ do not exceed the largest side of the triangle $x_1x_2x_3$ --- hence the result.
\qeds
