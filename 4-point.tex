...
It remains to prove the inequality in the corollary for this $\lambda$-array.
...
Note that for a general 4-point array, $\tilde d_v$ and $\tilde d_w$ do not exceed the largest side of the triangle $x_1x_2x_3$;
