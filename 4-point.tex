...
$d_v$ and $d_w$ are distances from a vertex of the model triangle $\tilde\triangle(x_1x_2x_3)$ to a point that divide the opposite side in a certain ratio and $\eps_v,\eps_w\ge 0$,
