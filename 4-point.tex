...
Further, in Section~\ref{Alexandrov's comparison}, we prove that a single nondegenerate inequality of negative type defines Alexandrov spaces with either nonnegative and nonpositive curvature.
...
We may not distinguish $\rho_{\bm{x}}$ and the corresponding semimetric on $\bm{x}=(x_1,\dots,x_n)$.
...
in the case of $(3,1)$-inequality, we have $0<\alpha<1$, and
in the case of $(2,2)$-inequality, we have $1<\alpha$.
...
(A way stronger result was proved by Vedrin Šahović in his thesis \cite{sahovic2009}.)
...
Since $K$ is closed, it contains forms associated with all metrics on 4-point set;
...
\end{aligned}
\eqlbl{eq:+squares}\]
for any 4-array $(x_1,x_2,x_3,x_4)$ with its form lying in $K$.
